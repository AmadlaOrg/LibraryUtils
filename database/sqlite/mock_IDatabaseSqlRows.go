...
// MockRows_ColumnTypes_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ColumnTypes'
type MockRows_ColumnTypes_Call struct {
	*mock.Call
}

// ColumnTypes is a helper method to define mock.On call
func (_e *MockRows_Expecter) ColumnTypes() *MockRows_ColumnTypes_Call {
	return &MockRows_ColumnTypes_Call{Call: _e.mock.On("ColumnTypes")}
}

func (_c *MockRows_ColumnTypes_Call) Run(run func()) *MockRows_ColumnTypes_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockRows_ColumnTypes_Call) Return(_a0 []*sql.ColumnType, _a1 error) *MockRows_ColumnTypes_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRows_ColumnTypes_Call) RunAndReturn(run func() ([]*sql.ColumnType, error)) *MockRows_ColumnTypes_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockRows_NextResultSet_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'NextResultSet'
type MockRows_NextResultSet_Call struct {
	*mock.Call
}

// NextResultSet is a helper method to define mock.On call
func (_e *MockRows_Expecter) NextResultSet() *MockRows_NextResultSet_Call {
	return &MockRows_NextResultSet_Call{Call: _e.mock.On("NextResultSet")}
}

func (_c *MockRows_NextResultSet_Call) Run(run func()) *MockRows_NextResultSet_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockRows_NextResultSet_Call) Return(_a0 bool) *MockRows_NextResultSet_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockRows_NextResultSet_Call) RunAndReturn(run func() bool) *MockRows_NextResultSet_Call {
	_c.Call.Return(run)
	return _c
}
