...
// MockCacheDatabase is an autogenerated mock type for the Database type
...
// CreateTable provides a mock function with given fields: sqlTables
func (_m *MockCacheDatabase) CreateTable(sqlTables *string) {
	_m.Called(sqlTables)
}
...
//   - sqlTables *string
func (_e *MockCacheDatabase_Expecter) CreateTable(sqlTables interface{}) *MockCacheDatabase_CreateTable_Call {
	return &MockCacheDatabase_CreateTable_Call{Call: _e.mock.On("CreateTable", sqlTables)}
}

func (_c *MockCacheDatabase_CreateTable_Call) Run(run func(sqlTables *string)) *MockCacheDatabase_CreateTable_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*string))
	})
	return _c
...
func (_c *MockCacheDatabase_CreateTable_Call) RunAndReturn(run func(*string)) *MockCacheDatabase_CreateTable_Call {
	_c.Run(run)
	return _c
}
