...
// MockUtilGitRemote is an autogenerated mock type for the Remote type
...
func (_m *MockUtilGitRemote) CommitHeadHash() (string, error) {
	ret := _m.Called()
...
func (_e *MockUtilGitRemote_Expecter) CommitHeadHash() *MockUtilGitRemote_CommitHeadHash_Call {
	return &MockUtilGitRemote_CommitHeadHash_Call{Call: _e.mock.On("CommitHeadHash")}
}

func (_c *MockUtilGitRemote_CommitHeadHash_Call) Run(run func()) *MockUtilGitRemote_CommitHeadHash_Call {
...
func (_c *MockUtilGitRemote_CommitHeadHash_Call) RunAndReturn(run func() (string, error)) *MockUtilGitRemote_CommitHeadHash_Call {
	_c.Call.Return(run)
	return _c
}

// Tags provides a mock function with no fields
func (_m *MockUtilGitRemote) Tags() ([]string, error) {
	ret := _m.Called()
...
func (_e *MockUtilGitRemote_Expecter) Tags() *MockUtilGitRemote_Tags_Call {
	return &MockUtilGitRemote_Tags_Call{Call: _e.mock.On("Tags")}
}

func (_c *MockUtilGitRemote_Tags_Call) Run(run func()) *MockUtilGitRemote_Tags_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockUtilGitRemote_Tags_Call) RunAndReturn(run func() ([]string, error)) *MockUtilGitRemote_Tags_Call {
	_c.Call.Return(run)
	return _c
}
