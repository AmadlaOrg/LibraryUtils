...
/*type Remote struct {
	...
	//
	// ⚠️ Removed ⚠️ -- None of the utility functions are inquiring to multiple URLs and there is no logic for handling it.
	// NOTE: Also, the single URL is already passed with the initialization of the Git Remote Service.
	//
	//URLs []string
