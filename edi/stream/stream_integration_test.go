...
func TestSWeave_DoWithJSONStringToFile(t *testing.T) {
	...
	// Call Do method
	err = NewStreamService(tmplPath, bytes.NewReader([]byte(input)), tempFile).Do()
	if err != nil {
...
func TestSWeave_DoWithJSONStringToStdout(t *testing.T) {
	...
	// Call Do method
	err = NewStreamService(tmplPath, bytes.NewReader([]byte(input)), &stdout).Do()
	if err != nil {
		t.Fatalf("Do method failed: %v", err)
	}
...
func TestSWeave_DoWithJSONFileToFile(t *testing.T) {
	...
	// Call Do method
	err = NewStreamService(tmplPath, inputHandle, tempFile).Do()
	if err != nil {
		t.Fatalf("Do method failed: %v", err)
	}
